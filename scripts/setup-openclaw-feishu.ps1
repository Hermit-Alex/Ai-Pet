...
Write-Host ""
Write-Host "Next:"
Write-Host "  1. Login Feishu: powershell -ExecutionPolicy Bypass -File .\scripts\login-openclaw-feishu.ps1"
Write-Host "  2. Restart the gateway: powershell -ExecutionPolicy Bypass -File .\scripts\run-openclaw-gateway.ps1"
