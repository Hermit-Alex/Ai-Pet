...
Write-Host ""
Write-Host "Next:"
Write-Host "  1. Restart the gateway: powershell -ExecutionPolicy Bypass -File .\scripts\run-openclaw-gateway.ps1"
Write-Host "  2. Login Weixin: powershell -ExecutionPolicy Bypass -File .\scripts\login-openclaw-weixin.ps1"
